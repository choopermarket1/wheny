...
- [명식]에 '이름'(한자 또는 한글)이 있으면, 맨 끝에 '## 이름 풀이' 항목을 추가하라: 그 이름 한자의 획수·오행·뜻을 성명학으로 읽고, 특히 사주에 <b>부족한 오행을 이름이 보완하는지</b>를 콕 짚어라(보완하면 "이름 잘 지었다", 아니면 보완법 제안). 이름이 없으면 이 항목을 넣지 마라.
